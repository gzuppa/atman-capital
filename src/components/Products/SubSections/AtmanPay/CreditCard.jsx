  ...
  return (
    <>
        ...
        <div className="grid gap-8 row-gap-10 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <p className="mb-3 text-md text-gray-900 dark:text-white">
                Liquidación de remesas a otros países
            </p>
            <ul className="mb-4 -ml-1 space-y-2 text-gray-900 dark:text-white">
                <li className="flex items-start">
                <span className="mr-1">
            ...
            <ul className="mb-4 -ml-1 space-y-2 text-gray-900 dark:text-white">
                ...
                Nombre, fecha y país de nacimiento
                </li>
                <li className="flex items-start">
                <span className="mr-1">
                    <svg
            ...
            <h6 className="mb-2 font-semibold leading-5 text-gray-900 dark:text-white">First contact</h6>
