        ...
        <div class="max-w-screen-xl px-4 mx-auto space-y-12 lg:space-y-20 lg:py-12 lg:px-6">
          <div class="items-center gap-8 lg:grid lg:grid-cols-2 xl:gap-16">
            ...
            <div class="text-gray-500 sm:text-lg dark:text-gray-400">
              <h2 class="animate-fade-left mb-4 text-3xl font-extrabold tracking-tight text-gray-900 dark:text-white">
                Obténla de forma inmediata en cualquier momento y cualquier
                lugar desde tu App
              </h2>
              ...
              >
                <li class="flex space-x-3">
                  <svg
                    class="flex-shrink-0 w-5 h-5 text-principalAmber dark:text-principalAmber"
                    fill="currentColor"
                    viewBox="0 0 20 20"
                ...
                <li class="flex space-x-3">
                  ...
                  <span class="animate-fade-left text-base font-medium leading-tight text-gray-900 dark:text-white">
                    Su tecnología Contactless te permite pagar de forma más
                    segura sin contacto, lo que minimiza el riesgo de fraude o
                    robo de información.
                  </span>
                </li>
              </ul>
        ...
        <div className="flex flex-col mb-6 lg:flex-row md:mb-10">
          ...
          <div className="lg:w-1/2">
            <p className="text-base md:text-lg text-gray-500 sm:text-lg dark:text-gray-400">
              Conoce los requisitos y descubre las ventajas de contar con una
              tarjeta totalmente hecha para ti.
            </p>
          </div>
        </div>
          ...
          <div>
            ...
            <ul className="mb-4 -ml-1 space-y-2 text-gray-900 dark:text-white">
              <li className="flex items-start">
                ...
                <p className="text-xs">
                  Acceso a red de más de 6,200 cajeros automáticos (Red en
                  México)
                </p>
              </li>
              <li className="flex items-start">
              ...
              <li className="flex items-start">
                ...
                <p className="text-xs">
                  Mastercard Global Service brinda asistencia en todo el mundo,
                  las 24 horas del día, con Informes de Tarjetas Perdidas y
                  Robadas, Reemplazo con Tarjeta de Emergencia y Anticipo de
              ...
              <li className="flex items-start">
                ...
                <p className="text-xs">
                  Control de tus movimientos a través de la APP
                </p>
              </li>
              <li className="flex items-start">
                <span className="mr-1">
                ...
                <p className="text-xs">
                  Tecnología Contactless para pago solo con acercar la tarjeta
                </p>
              </li>
              <li className="flex items-start">
                <span className="mr-1">
                ...
                <p className="text-xs">
                  Todos los beneficios, descuentos y promociones que se ofrecen
                  por MasterCard® como 2 x1 en Cinepolis®, 10% de descuento en
                  Mercado Libre® o Uber One® gratis los 3 primeros meses,
                  entre muchos otros
                </p>
              </li>
              <li className="flex items-start">
                ...
                <p className="text-xs">
                  Sin comisión por el uso en el extranjero
                </p>
              </li>
            </ul>
          </div>
          <div>
            ...
            <ul className="mb-4 -ml-1 space-y-2 text-gray-900 dark:text-white">
              <li className="flex items-start">
                ...
                <p className="text-xs">
                  Envía o recibe pagos de forma económica y fácil a cualquier
                  parte del mundo, en cualquier divisa
                </p>
              </li>
              <li className="flex items-start">
                <span className="mr-1">
              ...
              <li className="flex items-start">
                ...
                <p className="text-xs">
                  Obtén seguridad y rapidez en el envío y recepción de pagos
                </p>
              </li>
            </ul>
          </div>
