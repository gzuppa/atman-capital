...
const Company = () => {
  return (
    <>
      <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full md:px-24 lg:px-8 lg:py-20 font-montserrat bg-gray-50 dark:bg-gray-900">
        <div className="max-w-xl mb-10 md:mx-auto sm:text-center lg:max-w-2xl md:mb-12 px-6 lg:px-0">
          ...
          <p className="text-base text-gray-700 dark:text-white md:text-lg mb-2">
            Nuestra plataforma te proporciona las herramientas necesarias para
            llevar tus finanzas corporativas al siguiente nivel.
          </p>
          <p className="text-base text-gray-700 dark:text-white md:text-lg mb-2">
        ...
        <div className="grid gap-0 row-gap-6 lg:grid-cols-4 grid-cols-2 px-4 lg:px-0">
          <div className="sm:text-center">
            <div className="flex items-center justify-center w-16 h-16 mb-4 rounded-full bg-indigo-50 sm:mx-auto sm:w-24 sm:h-24">
              ...
              >
                ...
                <g id="SVGRepo_iconCarrier">
                  ...
                  <g>
                    {" "}
                    <path d="M16,6.1V5c0-1.7-1.3-3-3-3H3C2.4,2,2,2.4,2,3s0.4,1,1,1c0.6,0,1,0.4,1,1v1.1c-1.7,0.4-3,2-3,3.9v16c0,2.2,1.8,4,4,4h10 c2.2,0,4-1.8,4-4V10C19,8.1,17.7,6.6,16,6.1z M13,26H7c-0.6,0-1-0.4-1-1s0.4-1,1-1h6c0.6,0,1,0.4,1,1S13.6,26,13,26z M14,16H6V5 c0-0.4-0.1-0.7-0.2-1H13c0.6,0,1,0.4,1,1V16z"></path>{" "}
                    <path d="M9.5,11h1c0.3,0,0.5,0.2,0.5,0.5S10.8,12,10.5,12H9c-0.6,0-1,0.4-1,1s0.4,1,1,1c0,0.6,0.4,1,1,1s1-0.4,1-1v-0.1 c1.1-0.2,2-1.2,2-2.4c0-1.4-1.1-2.5-2.5-2.5h-1C9.2,9,9,8.8,9,8.5S9.2,8,9.5,8H11c0.6,0,1-0.4,1-1s-0.4-1-1-1c0-0.6-0.4-1-1-1 S9,5.4,9,6v0.1C7.9,6.3,7,7.3,7,8.5C7,9.9,8.1,11,9.5,11z"></path>{" "}
                  </g>{" "}
                  <g>
                    {" "}
            ...
            <h6 className="text-gray-700 dark:text-white mb-2 font-semibold leading-5">
              Pago a proveedores
            </h6>
          </div>
          <div className="sm:text-center">
      ...
      <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full md:px-24 lg:px-8 lg:py-20 font-montserrat bg-white dark:bg-gray-800">
      ...
      <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full md:px-24 lg:px-8 lg:py-20 font-montserrat bg-white dark:bg-gray-900">
        <div className="grid max-w-screen-lg gap-8 row-gap-5 md:row-gap-8 sm:mx-auto lg:grid-cols-2">
          <div className="transition duration-300 transform bg-white rounded shadow-sm hover:-translate-y-1 hover:shadow md:text-center">
            <div className="relative">
              <img
            ...
            <div className="px-6 py-8 border border-t-0 rounded-b sm:px-8">
              ...
              <p className="mb-5 text-gray-700">
                ...
                empresa. Además, nuestras tarjetas corporativas te ofrecen
                beneficios exclusivos y descuentos en una amplia red de
          ...
          <div className="transition duration-300 transform bg-white rounded shadow-sm hover:-translate-y-1 hover:shadow md:text-center">
            ...
            <div className="px-6 py-8 border border-t-0 rounded-b sm:px-8">
              ...
              <p className="mb-5 text-gray-700">
                ...
                plazos y tasas competitivas, permitiéndote obtener el capital
                necesario para alcanzar todas tus metas empresariales.
              </p>
            </div>
          </div>
        </div>
