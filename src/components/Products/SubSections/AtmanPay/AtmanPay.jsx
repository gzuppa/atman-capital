          ...
          <div class="max-w-screen-xl px-4 mx-auto space-y-12 lg:space-y-20 lg:py-12 lg:px-6">
            <div class="items-center gap-8 lg:grid lg:grid-cols-2 xl:gap-16 px-4 lg:px-0">
                ...
                >
                  <li class="flex space-x-3">
                    ...
                    <span class="animate-fade-left text-base font-medium leading-tight text-gray-900 dark:text-white">
                      Podrás realizar el alta de tu cuenta donde quiera que
                      estés.
                    </span>
                  </li>
                  <li class="flex space-x-3">
                    ...
                    <span class="animate-fade-left text-base font-medium leading-tight text-gray-900 dark:text-white">
                      Tendrás la posibilidad de realizar transferencias
                      individuales y colectivas 24/7 y descargar tus
                  ...
                  <li class="flex space-x-3">
                    ...
                    <span class="animate-fade-left text-base font-medium leading-tight text-gray-900 dark:text-white">
                      Podrás consultar tus estados de cuenta y movimientos de
                      forma fácil, ágil, cómoda y segura.
                    </span>
                  </li>
                  <li class="flex space-x-3">
                    <svg
                    ...
                    <span class="animate-fade-left text-base font-medium leading-tight text-gray-900 dark:text-white">
                      Tendrás acceso a pagos de servicios.
                    </span>
                  </li>
                </ul>
                <div>
              ...
              <img
                ...
                src="https://res.cloudinary.com/gusironhack/image/upload/v1741926005/WhatsApp_Image_2025-03-13_at_9.52.51_AM-removebg-preview_ofnjgr.png"
                alt="cellphone"
              />
            </div>
          </div>
