  ...
  return (
    <section class="body-font relative bg-gray-50 dark:bg-gray-800 text-gray-900 dark:text-white font-montserrat">
        <div class="container mx-auto px-5 py-24">
            ...
            <p class="mx-auto text-base leading-relaxed lg:w-2/3">Estaremos encantados de ayudarte
            </p>
            </div>
            ...
            <div class="-m-2 flex flex-wrap">
                ...
                <button class="mx-auto flex rounded border-0 bg-principalAmber py-2 px-8 text-lg text-white hover:bg-principalAmber focus:outline-none">Enviar</button>
                </div>
            </div>
            </div>
        </div>
