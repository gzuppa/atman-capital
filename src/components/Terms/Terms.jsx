          ...
          <div className="space-y-8">
            <div>
              <p className="text-gray-900 dark:text-white">
                ...
                el uso y registro de alguna operación aceptando y obligándose al
                cumplimiento de lo consignado en el presente documento.
                <br />
                <br />
                3.- Si el Usuario no acepta en forma absoluta y completa los
                Términos y Condiciones aquí consignados, el Usuario deberá
                abstenerse de acceder, utilizar y observar el Sitio y en caso de
                que el Usuario acceda, utilice y observe el Sitio se considerará
                como una absoluta y expresa aceptación de los Términos y
                ...
                <br />
                <br />
                5.- Los servicios ofrecidos en el Sitio son gratuitos y sólo
                ...
                esta condición deberán abstenerse de proporcionar información
                personal para ser incluida en nuestras bases de datos y/o
                acceder al Sitio.
                <br />
                <br />
                ...
                Sitio, consignados en este documento.
                <br />
                <br />
                ...
                <br />
                <br />
                10.- El Usuario reconoce que cualquier actividad propuesta en el
                Sitio y/o los documentos que de ellas se generan, no son
                susceptibles de circular y por ende, ninguno de los documentos,
                actividades, obligaciones y derechos antes mencionados, versan
                sobre “valores” según se define en la Ley del Mercado de
                ...
                Confidencial”). La Información Confidencial comprenderá, en
                forma enunciativa más no limitativa, correspondencia,
                ...
                Confidencial en estricta confidencialidad, y en este acto se
                obliga a no vender, divulgar, transferir, modificar, traducir,
                reproducir ni poner de otra forma Información Confidencial a
                disposición de terceros. El Usuario se obliga a poner el cuidado
                necesario en la protección de la Información Confidencial.
                <br />
                <br />
                15.- El Usuario acepta y reconoce que las obligaciones de
                confidencialidad estarán vigentes durante todo el tiempo en que
                la Información Confidencial conserve dicho carácter. Asimismo,
                el Usuario reconoce que la divulgación no autorizada de la
                ...
                <br />
                <br />
                16.- El Usuario sólo podrá imprimir y/o copiar cualquier
                información contenida o publicada en el Sitio exclusivamente
                para uso personal, quedando terminantemente prohibido el uso
                ...
                artificioso o engañoso; iii) violatorio de derechos de autor,
                marcas, confidencialidad, secretos industriales o cualquier
                derecho de propiedad intelectual de un tercero; iv) ofensivo o;
                v) que de cualquier forma contravenga lo establecido en los
                ...
                <br />
                <br />
                20.- El Usuario está obligado a no modificar, alterar o
                suprimir, ya sea en forma total o parcial, los avisos, marcas,
                nombres comerciales, señas, anuncios, logotipos o en general
                cualquier indicación que se refiera a la propiedad de la
                ...
                en general cualquier falla del Sitio, siendo, por ende, la
                responsabilidad del Usuario el contar con los antivirus,
                ...
                <br />
                <br />
                27. Está expresamente prohibido compartir con otros Usuarios,
                información personal (nombre, domicilio, teléfono, correo
                electrónico, dirección, edad, etc.) por medio de plataforma, el
                Sitio no asume ninguna responsabilidad, en caso del uso
                incorrecto de la plataforma por parte del Usuario.
                <br />
                <br />
                28.- La plataforma está disponible para los usuarios las 24
                horas del día, los 365 días del año para realizar operaciones y
                adquirir servicios, en la misma. Los horarios de atención a
                clientes son los siguientes: lunes a viernes 9:00 a 18:00 h.
              </p>
            </div>
          </div>
        </div>
