const ThirdSection = () => {
  ...
  const RegulationItem = ({ url, text }) => {
    return (
      <div>
        <div className="relative pb-56 mb-4 rounded shadow lg:pb-64 bg-white dark:bg-gray-300">
          <img
        ...
        <div className="flex flex-col sm:text-center">
          <p className="mb-5 text-xs text-gray-800 dark:text-white">{text}</p>
        </div>
      </div>
    );
  };
          ...
          <div className="mx-auto mb-10 lg:max-w-xl sm:text-center">
            <h2 className="dark:text-white max-w-lg mb-6 font-montserrat text-3xl font-bold leading-none tracking-tight text-gray-900 sm:text-4xl md:mx-auto">
              <span className="relative inline-block">
                ...
                <span className="relative">Regulación</span>
              </span>{" "}
            </h2>
          </div>
          <div className="grid gap-10 mx-auto sm:grid-cols-2 lg:grid-cols-3 lg:max-w-screen-lg">
            <RegulationItem
              url="https://res.cloudinary.com/gusironhack/image/upload/v1741314662/shcp_tcmr6r.png"
              text="La Secretaría de Hacienda y Crédito Público dirige y controla la política económica del Gobierno Federal en materia financiera, fiscal, de gasto, de ingresos y deuda pública con el propósito de consolidar un país con crecimiento económico."
            />
            <RegulationItem
              url="https://res.cloudinary.com/gusironhack/image/upload/v1741314917/cnbv_l6njz4.svg"
              text="La Comisión Nacional Bancaria y de Valores supervisa y regula las entidades integrantes del sistema financiero mexicano a fin de procurar su estabilidad y correcto funcionamiento."
            />
            <RegulationItem
              url="https://res.cloudinary.com/gusironhack/image/upload/v1741315013/conduseflogo_phruax.png"
              text="La Comisión Nacional para la Defensa de los Usuarios de Servicios Financieros promueve y difunde la educación financiera sobre los productos ofertados en el sistema financiero mexicano"
            />
          </div>
        </div>
      </section>
