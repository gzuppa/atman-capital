...
const Hero = () => {
  ...
  return (
    <div class="min-h-screen flex justify-center items-center bg-hero bg-fixed bg-no-repeat bg-cover bg-center">
      <Stack spacing={2}>
        <h1 class="font-montserrat text-6xl text-white font-bold text-center">Atman</h1>
        <h1 class="font-montserrat text-2xl text-white text-center">Empoderamos tus finanzas</h1>
        <a
          href="/quienes-somos"
        ...
        >
          ...
          >
            <div
              class="group-hover:scale-100 flex justify-center group-hover:text-yellow-500 text-yellow-600 gap-1"
            >
